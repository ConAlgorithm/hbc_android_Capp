#include "Java_com_huangbaoche_hbcframe_util_JNIUtil.h"
#include <string.h>
#include <stdio.h>

jstring Java_com_huangbaoche_hbcframe_util_JNIUtil_getSign(JNIEnv* env, jobject thizz,
		jobject thiz) {
