 ...
 */
public class IMChatActivity extends BaseActivity implements IMUtil.OnImSuccessListener{
...
//            resetStatusColor(textView, letterOrder.status);
    ...
    private String getTypeStr(OrderBean orderBean) {
        ...
        MLog.e("getOrderTypeStr = " + orderBean.getOrderTypeStr(IMChatActivity.this));
        if (orderBean.orderGoodsType == 5) {
            sb.append("[" + orderBean.getOrderTypeStr(IMChatActivity.this) + "]");
    ...
    public void showPopupWindow() {
        ...
        if (menuLayout == null) {
            menuLayout  = LayoutInflater.from(IMChatActivity.this).inflate(R.layout.popup_top_right_menu, null);
        }
        ...
        cancelOrderTV.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(inBlack == 0) {
                    AlertDialogUtils.showAlertDialog(IMChatActivity.this, getString(R.string.black_man), "确认拉黑", "取消", new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialog, int which) {
//                        cancelOrderTV.setText("解除拉黑");
                            RequestBlackMan requestBlackMan = new RequestBlackMan(IMChatActivity.this, userId);
                            HttpRequestUtils.request(IMChatActivity.this, requestBlackMan, new HttpRequestListener() {
                                @Override
                    ...
                    RequestUnBlackMan requestUnBlackMan = new RequestUnBlackMan(IMChatActivity.this, userId);
                    HttpRequestUtils.request(IMChatActivity.this, requestUnBlackMan, new HttpRequestListener() {
                        @Override
                        public void onDataRequestSucceed(BaseRequest request) {
                            inBlack = 0;
                        }
...
//                        }
    ...
    private void requestApiFeedback(int errorMessage, String errorCode) {
        RequestApiFeedback requestApiFeedback = new RequestApiFeedback(IMChatActivity.this,
                UserEntity.getUser().getUserId(IMChatActivity.this),
                ApiFeedbackUtils.getImErrorFeedback(errorMessage, errorCode));
        HttpRequestUtils.request(IMChatActivity.this, requestApiFeedback, new HttpRequestListener() {
            @Override
            public void onDataRequestSucceed(BaseRequest request) {
