...
public class LoginNewActivity extends BaseActivity implements TextWatcher {
    ...
    public void onDataRequestSucceed(BaseRequest request) {
        ...
        if (request instanceof RequestLogin) {
            ...
            UserEntity.getUser().setUnionid(LoginNewActivity.this, "");
            try {
            ...
            UserEntity.getUser().setUnionid(LoginNewActivity.this, userBean.unionid);
            if (userBean.isNotRegister == 1) {//未注册，走注册流程
                Bundle bundle = new Bundle();
                bundle.putString("unionid", userBean.unionid);
                bundle.putString("source", getEventSource());
                Intent intent = new Intent(LoginNewActivity.this, BindMobileActivity.class);
...
//                collapseSoftInputMethod(); //隐藏键盘
                intent = new Intent(LoginNewActivity.this, ChooseCountryActivity.class);
...
//                collapseSoftInputMethod(); //隐藏键盘
                ...
                intent = new Intent(LoginNewActivity.this, RegisterActivity.class);
...
//                collapseSoftInputMethod(); //隐藏键盘
                ...
                intent = new Intent(LoginNewActivity.this, ForgetPasswdActivity.class);
