...
public class ZipUtils {
    ...
    public  static  void test(){
        String zipFileString = Config.getRootDir()+"Download/test.zip";
        String outPathString = Config.getRootDir()+"Download/test";
        try {
            ...
            while ((zipEntry = inZip.getNextEntry()) != null) {
                ...
                if (zipEntry.isDirectory()) {
                    ...
                    if(!file.getParentFile().exists()){
                        MLog.e(file.getParentFile().getPath() + " file.getParentFile not exists");
        ...
        private static void ZipFiles(String folderString, String fileString, ZipOutputStream zipOutputSteam)throws Exception {
            ...
            if (file.isFile()) {
                ...
                //flightNo child file and compress
