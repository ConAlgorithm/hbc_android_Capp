...
public enum ChooseCarTypeEnum {
     ...
     * @return
     */
    public static ChooseCarTypeEnum getCarType(int type, int seat) {
        String carLabel = "T" + type + "S" + seat;
        try {
            return ChooseCarTypeEnum.valueOf(carLabel);
        } catch (Exception e) {
