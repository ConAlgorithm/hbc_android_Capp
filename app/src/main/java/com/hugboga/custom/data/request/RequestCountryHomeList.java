...
public class RequestCountryHomeList extends BaseRequest<CityHomeBean> {


    public RequestCountryHomeList(Context context, String countryId, int offset, int daysCountMin, int daysCountMax, int goodsClass, int themeId) {
        super(context);
        map = new HashMap<>();
