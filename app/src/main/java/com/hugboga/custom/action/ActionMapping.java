...
//        arrayMap.put(ActionPageType.SKU_LIST, ActionPageWeb.class);                         // 4：商品列表页（type：组合、国家、城市，areaId, areaName）
//        arrayMap.put(ActionPageType.SKU_DETAIL, ActionPageWeb.class);                       // 5：商品详情页（cityId, goodsNo）
        arrayMap.put(ActionPageType.CHARTERED_CAR, ActionPageCharteredCar.class);                    // 6：自定义包车游
//        arrayMap.put(ActionPageType.PICK_UP, ActionPageWeb.class);                          // 7：中文接机
//        arrayMap.put(ActionPageType.SEND, ActionPageWeb.class);                             // 8：中文送机
...
//        arrayMap.put(ActionPageType.ORDER_LIST, ActionPageWeb.class);                       // 11：订单列表（type:进行中、已完成、已取消）
//        arrayMap.put(ActionPageType.ORDER_DETAIL, ActionPageWeb.class);                     // 12：订单详情（登录、orderNo，orderType）
...
//        arrayMap.put(ActionPageType.GUIDE_DETAIL, ActionPageWeb.class);                     // 20：司导详情页（登录、司导ID）
...
//        arrayMap.put(ActionPageType.CHAT_LIST, ActionPageWeb.class);                        // 30：私聊列表
