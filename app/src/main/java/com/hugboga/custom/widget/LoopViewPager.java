...
public class LoopViewPager extends ViewPager {
    ...
    public void setAdapter(PagerAdapter adapter) {
        ...
        mWrapperAdapter = new LoopPagerAdapterWrapper(adapter);
        mWrapperAdapter.setBoundaryCaching(mBoundaryCaching);
    ...
    public int getCurrentItem() {
        return mWrapperAdapter != null ? mWrapperAdapter.toRealPosition(super.getCurrentItem()) : 0;
    }

    public void setCurrentItem(int item, boolean smoothScroll) {
        if (mWrapperAdapter == null) mWrapperAdapter = new LoopPagerAdapterWrapper(mAdaper);
    ...
    private OnPageChangeListener onPageChangeListener = new OnPageChangeListener() {
        ...
        public void onPageSelected(int position) {
            if (mWrapperAdapter == null || mWrapperAdapter.getMAdapter() == null) {
                return;
            }
        ...
        public void onPageScrolled(int position, float positionOffset, int positionOffsetPixels) {
            ...
            if (mWrapperAdapter != null) {
                ...
                if (positionOffset == 0
                        && mPreviousOffset == 0
                        && (position == 0 || position == mWrapperAdapter.getCount() - 1)) {
                    setCurrentItem(realPosition, false);
                }
            }

            mPreviousOffset = positionOffset;
            if (mOuterPageChangeListener != null && mWrapperAdapter != null && mWrapperAdapter.getRealAdapter() != null) {
    ...
    public void setScrolDuration(int mDuration) {
