...
public class FlowLayout extends ViewGroup {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (orientation == HORIZONTAL) {
            if (singleLine) {
                this.setMeasuredDimension(resolveSize(controlMaxLength, widthMeasureSpec), resolveSize(singleLineHeight, heightMeasureSpec));
            } else {
    ...
    private void readStyleParameters(Context context, AttributeSet attributeSet) {
        ...
        try {
            horizontalSpacing = a.getDimensionPixelSize(R.styleable.FlowLayout_fhorizontalSpacing, 0);
            verticalSpacing = a.getDimensionPixelSize(R.styleable.FlowLayout_fverticalSpacing, 0);
