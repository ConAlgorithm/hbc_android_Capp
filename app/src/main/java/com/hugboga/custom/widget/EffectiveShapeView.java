...
public class EffectiveShapeView extends ImageView {
    ...
    public EffectiveShapeView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if (attrs != null) {
            ...
            mRx = a.getDimensionPixelOffset(R.styleable.EffectiveShapeView_radius_x, mRx);
            mRy = a.getDimensionPixelOffset(R.styleable.EffectiveShapeView_radius_y, mRy);
            mDecorationsView = a.getDrawable(R.styleable.EffectiveShapeView_decorations_src);
            mBorderColor = a.getColor(R.styleable.EffectiveShapeView_border_color, 0x00000000);
            mBorderWidth = a.getDimensionPixelOffset(R.styleable.EffectiveShapeView_border_width, 0);
            a.recycle();
        }
